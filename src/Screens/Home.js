      ...
      >
        <div className={styles.sectionContainer}>
          ...
          <div className={styles.sectionSubtitle}>
            ...
            Nuestra metodología tiene lo mejor del aprendizaje virtual, permitiéndo a nuestros usuarios aprender desde cualquier
          ...
          <div className={styles.cardsGrid}>
            <motion.div className={styles.serviceCard} whileHover={{ y: -10, boxShadow: '0 10px 20px rgba(231, 0, 20, 0.2)' }}>
              ...
              <p>Aprende defensa personal desde cualquier lugar con material exclusivo.</p>
            </motion.div>
