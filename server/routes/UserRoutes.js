...
const { signIn, registerUser, sessionUser, logoutUser, getUsuariosActivos, getUsuariosInactivos, updateStatusUsuarios, updateUserProfile, getBuyUser, getPurchasedCourses } = require("../controllers/UserController");
...
router.get("/api/getPurchasedCourses", getPurchasedCourses );
